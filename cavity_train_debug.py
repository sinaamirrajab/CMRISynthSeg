...
### sina starts ### training options for cmr images
# opt.name = 'LGE_spade_w_norm_64_vae_few_Mar_10'
# opt.name = 'LGE_pix2spade_debug'
# opt.name = 'LGE_stylespade_debug'
opt.name = 'LGE_stylespade_debug_3'
opt.dataset_mode = 'cmrcavityLGEAug'
# opt.label_dir = '/data/sina/dataset/LGE_emidec/AI_image_data/3D_patients/no_normalization/'
# opt.image_dir = '/data/sina/dataset/LGE_emidec/AI_image_data/3D_patients/no_normalization/'
# opt.label_dir = '/data/sina/dataset/LGE_emidec/AI_image_data/3D_patients/with_normalization/'
# opt.image_dir = '/data/sina/dataset/LGE_emidec/AI_image_data/3D_patients/with_normalization/'

opt.label_dir = '/home/sina/data/LGE/3D_patients_normalized'
opt.image_dir = '/home/sina/data/LGE/3D_patients_normalized'
opt.netG = 'stylespade'
