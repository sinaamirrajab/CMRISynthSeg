...
class CmrmultivalidDataset(Pix2pixDataset):
    ...
    def modify_commandline_options(parser, is_train):
        ...
        parser.add_argument('--label_dir', type=str, required=False, default = '/data/sina/dataset/MMs_Processed/Center_1/Patch_Size_256/Mask_Original',
                            help='path to the directory that contains label images')
        parser.add_argument('--image_dir', type=str, required=False, default ='/data/sina/dataset/MMs_Processed/Center_1/Patch_Size_256/Image' ,
