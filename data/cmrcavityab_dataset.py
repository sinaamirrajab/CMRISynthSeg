...
class CmrcavityabDataset(Pix2pixDataset):
    ...
    def modify_commandline_options(parser, is_train):
        ...
        parser.add_argument('--label_dir', type=str, required=False, default = '/data/sina/dataset/M_Ms/OpenDataset/processed_MMs/Vendor_A/Mask/',
                            help='path to the directory that contains label images')
        parser.add_argument('--image_dir', type=str, required=False, default ='/data/sina/dataset/M_Ms/OpenDataset/processed_MMs/Vendor_A/Image/' ,
                            help='path to the directory that contains photo images')
        parser.add_argument('--label_dirb', type=str, required=False, default = '/data/sina/dataset/M_Ms/OpenDataset/processed_MMs/Vendor_B/Mask/',
                            help='path to the directory that contains label images')
        parser.add_argument('--image_dirb', type=str, required=False, default ='/data/sina/dataset/M_Ms/OpenDataset/processed_MMs/Vendor_B/Image/' ,
                            help='path to the directory that contains photo images')
