...
class CmrmultiACDCDataset(Pix2pixDataset):
    ...
    def modify_commandline_options(parser, is_train):
        ...
        parser.set_defaults(crop_size=265)
        parser.set_defaults(no_instance=True)
        

        parser.add_argument('--label_dir', type=str, required=False, default = '/data/sina/dataset/MMs_Processed/ACDC_Original/Mask/Frame1',
                            help='path to the directory that contains label images')
        parser.add_argument('--image_dir', type=str, required=False, default ='/data/sina/dataset/MMs_Processed/ACDC_Original/Image/Frame1/Image' ,
        ...
        parser.set_defaults(target_res=1.52)
        return parser
    ...
    def initialize(self, opt):
        ...
        if opt.phase == 'train':
            train_transforms = Compose([
                cmr_tran.Resample(opt.target_res,opt.target_res),
